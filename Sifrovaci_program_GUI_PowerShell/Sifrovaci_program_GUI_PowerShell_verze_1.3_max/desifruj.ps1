...
# prazdny matrix v 1.3
for ( $hh = 0; $hh -le 125; $hh++ ) { # radku pod sebou
# delka 1296 klicu na kazdym radku
$vv=@()
for ( $dd3 = 0; $dd3 -le 3843; $dd3++ ) { # 0-3843
$vv+=""
}
