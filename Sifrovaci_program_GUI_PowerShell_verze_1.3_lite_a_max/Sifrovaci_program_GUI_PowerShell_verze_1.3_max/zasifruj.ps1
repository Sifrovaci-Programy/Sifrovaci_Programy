...
# 4.11.2024 start cas nacitani souboru klice
$start_stamp_1 = [DateTimeOffset]::Now.ToUnixTimeseconds()
echo "nacitam soubor klice..."
...
$kraje_matrix+=$matrix[0][3843].Length
$kraje_matrix+=$matrix[125][0].Length
$kraje_matrix+=$matrix[125][3843].Length
#echo $kraje_matrix
...
#echo $ff
$rnd_num = Get-Random -Minimum 0 -Maximum 3843 # novy verze 1.3
#echo $rnd_num
...
#$reference_na_heslo_base += ConvertTo-NumeralBase -Number $rnd_num -Base 36
#$reference_na_heslo += [string] $rnd_num - puvodni 1.1
