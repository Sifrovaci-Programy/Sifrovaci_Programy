...
echo "byl vybran soubor $vybrany_rar"
Remove-Variable volba
...
$rok_nazev_rar = $vybrany_rar.Substring(6,4)
...
#$hledej_datum += "XXX" # testovaci aby nic nenasel                               <<<<<<<<
...
sleep 10
& $rar "x" "-p$heslo" "-y" "$path_email$hledej_datum.rar" "$path_email/"
