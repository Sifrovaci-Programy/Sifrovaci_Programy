#!/usr/bin/lua
-- ubuntu verze 5 cte datum z komentare (parametr "-c") z archivu zip
-- Lua 5.2.4
...
cesta_zip_slozka = '/home/pi/c/Documents\\ and\\ Settings/DELL/Dokumenty/archivy_ubuntu/'
--komentar_zip = "/home/pi/c/Documents and Settings/DELL/Dokumenty/archivy_ubuntu/" #nefungovalo moc dlouha cesta !
--zip to nevzal (co nejkratsi cesta a zadni mezery apod.)
komentar_zip = "/home/pi/KomentarZip.txt"
...
--komentar_zip = "/home/pi/.KomentarZip.txt" -- nedavat sem dlouhou cestu nefunguje pak !
...
--komentar_zip = "/home/pi/KomentarZip.txtxsdsds" -- testovaci
